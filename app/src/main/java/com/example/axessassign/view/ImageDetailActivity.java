...
import com.example.axessassign.database.ImageDatabase;
import com.example.axessassign.databinding.ActivityImageDetailsBinding;
...
public class ImageDetailActivity extends AppCompatActivity {
    ...
    private void saveCommentInDatabase() {
        if(activityImageDetailsBinding.edtTxtComment.getText().toString().isEmpty()){
            AppUtility.INSTANCE.showSnackBar(activityImageDetailsBinding.getRoot(),"Empty data not allowed !");
        }else {
            ...
            AppUtility.INSTANCE.showSnackBar(activityImageDetailsBinding.getRoot(),"Comment saved !");
